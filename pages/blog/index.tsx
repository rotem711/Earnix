...
const Blog = (props: {
  ...
  const {
    entry, nav, seo, header, globals, footer, translations, featured,
  } = props
    ...
    >
      ...
      <main>
        ...
        <div className="container">
          <div className="gap-x-30 grid md:grid-cols-8 xxl:grid-cols-12 pb-60">
            <div className="md:col-span-8 xxl:col-start-3 flex sm:flex-col md:flex-row gap-8 sm:gap-0 items-start sm:items-left md:items-center justify-between">
              <h2 className="text-orange-100">{entry.title}</h2>
              <div>
            ...
            <div className="col-span-3 md:col-span-8 xxl:col-span-6 xxl:col-start-3 flex flex-col gap-x-30 gap-y-60 md:grid-cols-8 pb-80">
              ...
              <div className="flex gap-x-30 gap-y-50 md:grid md:grid-cols-8 overflow-x-auto md:hidden sm:visible">
                {filteredDynamicArticles.map((article, index) => {
                  if (
                    counter >= articlesInFirstCarouselQuantity
                    && index > counter
                  ) {
                    counter += 1
                    const articleDetails = renderArticleDetails(article)
